...
type VProjectInfoDao struct {
    mysqlModel.VProjectInfoModel
}

func (m *VProjectInfoDao) Get() error {
...
func (m *VProjectInfoDao) Add() error {
    mysqlManager := database.GetMysqlClient()
    err := m.Get()
    if err == nil {
...
func (m *VProjectInfoDao) Update(args map[string]interface{}) error {
    mysqlManager := database.GetMysqlClient()
    err := m.Get()
    if err != nil {
        return err
...
func (m *VProjectInfoDao) Delete() error {
    mysqlManager := database.GetMysqlClient()
    err := m.Get()
    if err != nil {
        return err
